    ...
    <div className={`w-[97%] mx-auto ${className}`}>
      ...
      <div className="carousel-mask">
        <Slider ref={sliderRef} {...settings}>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[0]} showDate={false}/>
          </div>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[1]} showDate={false}/>
          </div>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[2]} showDate={false}/>
          </div>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[3]} showDate={false}/>
          </div>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[4]} showDate={false}/>
          </div>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[5]} showDate={false}/>
          </div>
          <div className="mr-5">
            <Review className={"xl:w-[400px]"} review={reviews[6]} showDate={false}/>
          </div>
        </Slider>
      </div>
    </div>
